...
- ProcessingView.tsx
- react
- diagram-extraction/gemini.test.ts
- devDependencies
- layout.tsx
...
Cohesion: 0.05
Nodes (86): Phase 5 diagram geometry state and element IDs, ref_node_assert, ref_node_test, three, fixtureResponse(), escapeXml(), generateGeometrySafely(), svgAudit() (+78 more)

### Community 1 - "upload-handler.ts"
Cohesion: 0.15
Nodes (21): UploadError, ClassifiedPage, FailedPage, PageResult, PreparedPage, RetrySession, RetrySessionStore, Phase1Config (+13 more)

### Community 2 - "document-processing/types.ts"
Cohesion: 0.06
Nodes (55): mupdf, ref_node_module, server-only, failure(), DiagramData, DiagramExtractor, DiagramProcessor, DiagramRegionResult (+47 more)

### Community 3 - "frontend_prompt.md"
Cohesion: 0.05
Nodes (41): 10. Upload card, 13. Trust / validation callout, 14. PROCESSING SCREEN, 16. Processing failure behaviour, 17. REVIEW SCREEN — MOST IMPORTANT SCREEN, 18. Review header, 19. Region navigator, 1. Design philosophy (+33 more)
...
Cohesion: 0.15
Nodes (14): @google/genai, ref_node_timers, getGeminiConfig(), ClassificationServiceError, classificationResponseSchema, GeminiRegionClassifier, logTokenUsage(), BACKOFF_MS (+6 more)

### Community 6 - "frontend-types.ts"
Cohesion: 0.12
Nodes (21): lucide-react, ExportView(), ExportViewProps, DocumentOutlineProps, EditRequestDialogProps, RegionNavigatorProps, ReviewActions(), ReviewActionsProps (+13 more)
...
Cohesion: 0.14
Nodes (18): Component Registry, Export Stage, Layout & Navigation, Processing Stage, Upload Stage, Home(), normalizeRegions(), AppHeader() (+10 more)
...
### Community 17 - "react"
Cohesion: 0.25
Nodes (8): react, Dialog(), DialogContent(), DialogDescription(), DialogFooter(), DialogHeader(), DialogTitle(), Textarea()

### Community 18 - "diagram-extraction/gemini.test.ts"
Cohesion: 0.31
Nodes (5): ref_node_fs, GeminiDiagramExtractor, extractCallTypeBPrompt(), getCallTypeBPrompt(), response()
...
### Community 21 - "diagram-extraction/gemini.ts"
Cohesion: 0.22
Nodes (6): DiagramProcessingError, DiagramValidationError, Generate, independentAxis, nullableString, responseSchema
...
Cohesion: 0.18
Nodes (18): ref_node_events, inspectPdf(), { values }, verifyFixture(), getBrailleGrade(), LocalTextRecognizer, TextRegionProcessor, createTextFixture() (+10 more)
...
Cohesion: 0.27
Nodes (10): Review Stage (Phase 6), BraillePreview(), DocumentOutline(), EditRequestDialog(), RegionNavigator(), ReviewWorkspace(), TablePreview(), ValidationSummary() (+2 more)
...
### Community 31 - "UnsupportedState.tsx"
Cohesion: 0.24
Nodes (8): Shared & Primitives, 34. EMPTY / ERROR / EDGE STATES, EmptyState(), EmptyStateProps, ErrorState(), UnsupportedState(), UnsupportedStateProps, ProcessingStatus
...
Cohesion: 0.50
Nodes (3): geminiEnvironmentSchema, phase1EnvironmentSchema, positiveInteger
...
### Community 50 - "repository.ts"
Cohesion: 0.15
Nodes (13): @supabase/supabase-js, POST(), runtime, Database, Json, isApprovableRegion(), regionRowId(), SupabaseJobRepository (+5 more)

### Community 51 - "verify-table-processing.ts"
Cohesion: 0.22
Nodes (14): repository, rows, { values }, DiagramRegionProcessor, openPdf(), TableRegionProcessor, createHarness(), createTableFixture() (+6 more)

### Community 52 - "UploadRateLimiter"
Cohesion: 0.17
Nodes (8): RFC-5737, getClientIp(), UploadRateLimiter, UploadDependencies, harness(), region, config, createHarness()

### Community 53 - "runtime.ts"
Cohesion: 0.23
Nodes (10): maxDuration, POST(), runtime, maxDuration, POST(), runtime, getPhase1Config(), getUploadDependencies() (+2 more)
...
Cohesion: 0.22
Nodes (8): ref_node_os, ref_node_path, ref_node_process, ref_node_util, bytes, document, extract(), { values }

### Community 57 - "JobRepository"
Cohesion: 0.32
Nodes (3): JobRepository, jobFailed(), syncJobStatus()
...
- **Why does `GeometryState` connect `generate.ts` to `document-processing/types.ts`, `AGENTS.md — Emboss`, `frontend-types.ts`, `Tactile3DViewer.tsx`, `Pipeline — Emboss`?**
