...
| `SourcePreview` | `src/components/review/SourcePreview.tsx` | Left pane displaying response-delivered MuPDF PNG crops with zoom/pan; legacy same-origin URL and 410 fallback | `region: PersistedRegionItem`, `className?: string` | Review split-screen |
