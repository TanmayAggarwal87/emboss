...
import type { ClassifiedRegion, JobRepository, PersistedRegion } from "../../src/lib/document-processing/types.ts";
import type { TextRegionResult } from "../../src/lib/text-processing/types.ts";
...
import type { DiagramExtractor } from "../../src/lib/diagram-extraction/types.ts";
...
import type { GeometryProcessor } from "../../src/lib/tactile-geometry/types.ts";
import { CHART_BOX, EXPECTED_CHARTS, createDiagramFixture } from "../diagram-extraction/fixtures.ts";
