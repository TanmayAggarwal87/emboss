...
import { DEFAULT_PROFILE, type PhysicalProfile } from "../../src/lib/phase5/profile.ts";
import { DeterministicGeometryProcessor } from "../../src/lib/phase5/generate.ts";
import type { GeometryState } from "../../src/lib/phase5/types.ts";
import type { SupportedDiagramData } from "../../src/lib/phase4/schema.ts";
